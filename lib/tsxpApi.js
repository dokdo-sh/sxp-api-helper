/*
 * A Promised NodeJS Module for connecting with the SXP API
 */

const request = require("request");
const Big = require('big.js');

const tsxpApi = /** @class */ (function() {

    function tsxpApi(apiURL) {
        if (apiURL === void 0)
            this.apiURL = 'https://sxp.testnet.sh/api';
        else
            this.apiURL = apiURL;
        tsxpApi
        return this;
    ...
    tsxpApi.prototype.getApiUrl = function() {
    ...
    tsxpApi.prototype.getBlockChain = function() {
    ...
    tsxpApi.prototype.getBlockHeight = function() {
    ...
    tsxpApi.prototype.listBlocks = function(page, limit, id, height, orderBy) {
    ...
    tsxpApi.prototype.getBlockByHeight = function(height) {
    ...
    tsxpApi.prototype.getBlockByID = function(id) {
    ...
    tsxpApi.prototype.getLastBlock = function() {

        return new Promise((resolve, reject) => {

            request.get(this.apiURL + '/blocks/last', { json: true }, function(error, response, body) {
    ...
    tsxpApi.prototype.getTransactionsByBlockID = function(id) {
    ...
    tsxpApi.prototype.searchBlocks = function(page, limit, body) {
    ...
    tsxpApi.prototype.listDelegates = function(page, limit, orderBy) {
    ...
    tsxpApi.prototype.getDelegate = function(identifier) {
    ...
    tsxpApi.prototype.getDelegateBlocks = function(identifier, page, limit) {
    ...
    tsxpApi.prototype.getDelegateVoters = function(identifier, page, limit) {
    ...
    tsxpApi.prototype.searchDelegates = function(page, limit, body) {
    ...
    tsxpApi.prototype.getNodeConfig = function() {
    ...
    tsxpApi.prototype.getNodeCryptoConfig = function() {
    ...
    tsxpApi.prototype.getNodeFeeStats = function() {
    ...
    tsxpApi.prototype.getNodeStatus = function() {
    ...
    tsxpApi.prototype.getNodeSyncStatus = function() {
    ...
    tsxpApi.prototype.getPeers = function(page, limit, port, status, os, version, orderBy) {
    ...
    tsxpApi.prototype.getPeerByIP = function(ip) {
    ...
    tsxpApi.prototype.createTransaction = function(transactions) {
        ...
        /*
            ...
            The Solar crypto SDKs provide the functionality needed in most major programming languages. https://www.github.com/solar-network/
    ...
    tsxpApi.prototype.getTransactionByID = function(id) {
    ...
    tsxpApi.prototype.listTransactions = function(page, limit, type, blockId, id, orderBy) {
    ...
    tsxpApi.prototype.listUnconfirmedTransactions = function(page, limit) {
    ...
    tsxpApi.prototype.getUnconfirmedTransactionByID = function(id) {
    ...
    tsxpApi.prototype.searchTransactions = function(page, limit, body) {
    ...
    tsxpApi.prototype.getTransactionTypes = function() {
    ...
    tsxpApi.prototype.getTransactionFees = function() {
    ...
    tsxpApi.prototype.listVotes = function(page, limit, orderBy) {
    ...
    tsxpApi.prototype.getVoteByID = function(id) {
    ...
    tsxpApi.prototype.listWallets = function(page, limit, orderBy) {
    ...
    tsxpApi.prototype.getWalletByID = function(id) {
    ...
    tsxpApi.prototype.getWalletBalance = function(id) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.get(this.apiURL + '/wallets/' + id, { json: true }, function(error, response, body) {
                ...
                if (body.data && body.data.balance) {
                    const expon = new Big('1e-8');
                    const humanbalance = new Big(body.data.balance).times(expon).toFixed(8);
    ...
    tsxpApi.prototype.getWalletTransactions = function(id, page, limit) {
    ...
    tsxpApi.prototype.getWalletReceivedTransactions = function(id, page, limit) {
    ...
    tsxpApi.prototype.getWalletSentTransactions = function(id, page, limit) {
    ...
    tsxpApi.prototype.getWalletVotes = function(id, page, limit) {
    ...
    tsxpApi.prototype.getTopWallets = function(page, limit) {
    ...
    tsxpApi.prototype.searchWallets = function(page, limit, body) {
